...
## 十二镜头 Reader Panel 与真人反馈

新项目在原有量化指标和 Persona 加权之上，必须顺序完成十二个观察镜头：首读进入、新读者、类型老读者、情节逻辑、人物共情、世界沉浸、节奏疲劳、文字清晰、情绪兑现、追读留存、付费价值、边界与可达。每个镜头都要给正文证据位置和阅读影响，缺字段即不能通过。

AI Reader Panel 是预测，不是真人反馈。真实读者的读完率、推荐意愿、付费意愿和停读点通过独立的人类反馈文件摄取，两者不得混用身份或证据标签。
